...
<section>
   <nav>
		<ol class="cd-breadcrumb triangle">
			<li class="current"><a href="<?php echo base_url('index.php/LandingController/demand'); ?>"><em>Order</em></a></li>
			...
			<li><a href="<?php echo base_url('index.php/LandingController/share');?>">Invite Friends</a></li>
